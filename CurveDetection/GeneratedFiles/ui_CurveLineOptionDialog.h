...
public:
    ...
    void setupUi(QDialog *CurveLineOptionDialog)
    {
        ...
        CurveLineOptionDialog->resize(302, 380);
        ...
        lineEditCurveMinAngle->setGeometry(QRect(160, 100, 113, 20));
        ...
        lineEditCurveNumIterations->setGeometry(QRect(160, 20, 113, 20));
        ...
        lineEditCurveMaxErrorRatioToRadius->setGeometry(QRect(160, 60, 113, 20));
        ...
        lineEditCurveMinPoints->setGeometry(QRect(160, 40, 113, 20));
        ...
        lineEditLineNumIterations->setGeometry(QRect(160, 20, 113, 20));
        ...
        pushButtonCancel->setGeometry(QRect(170, 340, 91, 31));
        pushButtonOK = new QPushButton(CurveLineOptionDialog);
        pushButtonOK->setObjectName(QStringLiteral("pushButtonOK"));
        pushButtonOK->setGeometry(QRect(40, 340, 91, 31));
